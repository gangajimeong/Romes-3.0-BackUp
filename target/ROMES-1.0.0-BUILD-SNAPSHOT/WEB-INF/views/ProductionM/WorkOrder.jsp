			...
			<table class="table table-bordered mt-2 tableArea">
				...
				<tbody id="monitor-tbody">
					<tr style="display: none" id="monitor-origin">
						...
						<td class="monitor-company">${i.company}</td>
						<td class="monitor-branch">${i.branch}</td>
						<td class="monitor-printer">${i.printer}</td>
						<td class="monitor-product">${i.product}</td>
						<td class="monitor-coating">${i.coating}</td>
						<td class="monitor-back">${i.back}</td>
						<td class="monitor-size">${i.size}</td>
						<td class="monitor-count">${i.count}</td>
						<td class="monitor-remark">${i.remark}</td>
						<td style="display: none;" class="monitor-manufacture">${i.manufacture}</td>
						<td style="display: none;" class="monitor-url">${i.url}</td>
